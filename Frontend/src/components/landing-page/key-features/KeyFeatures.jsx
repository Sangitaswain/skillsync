        ...
        <div className='w-full bg-primary pt-[142px] pb-[122px] flex flex-col items-center gap-20'>
            ...
            <div className='flex gap-8'>
                <FeatureCard 
                    ...
                    description="Al-driven skill development tailored to industry demands and your career goals."
                />
                <FeatureCard 
                    icon={Feature2} 
                ...
                <FeatureCard 
                    ...
                    description="Data-driven insights to track progress and optimize hiring decisions."
                />
            </div>
        </div>
